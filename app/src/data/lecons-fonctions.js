...
const SOMME = {
  ...
  exercices: [
    { titre: 'Exercice 15 · La somme automatique', ex: 'x1' },
    { titre: 'Exercice 16 · La somme', ex: 'x2' },
  ],
  narration: [
...
const CALCULS = {
  ...
  exercices: [
    { titre: 'Exercice 5 · Les calculs avec les opérateurs', ex: 'x3' },
  ],
  narration: [
...
const SAISIE = {
  ...
  exercices: [
    { titre: 'Exercice 1 · Saisie et modification de données', ex: 'x4' },
    { titre: 'Exercice 2 · Saisie et modification de données', ex: 'x5' },
    { titre: 'Exercice 3 · Saisie et modification de données', ex: 'x6' },
    { titre: 'Exercice 4 · Saisie et modification de données', ex: 'x7' },
  ],
  narration: [
...
const RECOPIE = {
  ...
  exercices: [
    { titre: 'Exercice 6 · Recopie des données et des formules', ex: 'x8' },
    { titre: 'Exercice 7 · Recopie des données et des formules', ex: 'x9' },
  ],
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'Un dernier point qui dépanne bien.',
      visuel: {
        type: 'methode',
        titre: 'Bon à savoir',
        blocs: [
          { etapes: ['Si tes formules ne se recalculent **pas toutes seules**, le mode de calcul est sûrement réglé sur **« Manuel »**.'] },
          { note: 'va dans **Formules > groupe Calcul > Options de calcul > Automatique**.', label: 'La solution' },
...
const REFERENCES = {
  ...
  exercices: [
    { titre: 'Exercice 19 · Les références absolues', ex: 'x10' },
  ],
  narration: [
    ...
    },
    {
      ...
      plus: ['**$A$1** → référence absolue : la colonne (A) ET la ligne (1) sont figées.', '**A$1** → ligne figée : le $ est devant le 1, seule la ligne reste bloquée.', '**$A1** → colonne figée : le $ est devant le A, seule la colonne reste bloquée.', '**A1** → référence relative : rien n\'est figé, tout s\'adapte à la recopie.'],
    },
    {
      humeur: 'accueil',
...
const DEPLACER = {
  ...
  exercices: [
    { titre: 'Exercice 11 · Déplacer ou copier des cellules', ex: 'x11' },
    { titre: 'Exercice 12 · Déplacer ou copier des cellules', ex: 'x12' },
    { titre: 'Exercice 13 · Déplacer ou copier des cellules', ex: 'x13' },
  ],
  narration: [
...
const COLLAGE = {
  ...
  exercices: [
    { titre: 'Exercice 14 · Collage spécial', ex: 'x14' },
  ],
  narration: [
    ...
    {
      humeur: 'accueil',
      dit: 'On y accède en deux gestes : copie ta cellule, puis **clic droit** sur la destination.',
      visuel: { type: 'collagespecial', etapes: ['Copie ta cellule (Ctrl + C ou clic droit > Copier)', 'Clic droit sur la cellule de destination', 'Clique sur Collage spécial…', 'Choisis ce que tu veux coller'] },
    },
    {
      humeur: 'pensif',
    ...
    {
      humeur: 'pensif',
      dit: 'La boîte **Collage spécial** s\'ouvre : voici tout ce que tu peux coller, à la carte.',
      visuel: { type: 'collagespecialdialog' },
    },
    ...
    {
      humeur: 'accueil',
      dit: 'À toi de trouver. Tu veux coller **le résultat 10 tout seul** (le chiffre, sans la formule =B2*C2 derrière). Dans le Collage spécial, tu choisis… ?',
      visuel: { type: 'question', options: ['Valeurs', 'Formules', 'Tout'], bonne: 0, explication: '« Valeurs » colle uniquement le résultat affiché (10) et retire la formule. « Formules » collerait la formule, « Tout » collerait les deux. Parfait pour figer un chiffre.' },
    },
    { humeur: 'pensif', dit: 'Exactement : **Collage spécial > Valeurs** colle le résultat **10** tout seul, sans la formule. Pratique pour figer un résultat.', visuel: tabCol({ D2: { t: '10', num: true, vert: true } }, null, 'D2') },
    {
      humeur: 'accueil',
...
const ASSISTANT = {
  ...
  exercices: [
    { titre: 'Exercice 17 · L\'assistant fonction', ex: 'x15' },
    { titre: 'Exercice 18 · Formule sans assistant fonction', ex: 'x16' },
  ],
  narration: [
...
const SERIES = {
  ...
  exercices: [
    { titre: 'Exercice 8 · Création de série', ex: 'x17' },
    { titre: 'Exercice 9 · Création de série', ex: 'x18' },
    { titre: 'Exercice 10 · Création de série', ex: 'x19' },
  ],
  narration: [
...
// ======================================================================
const EX3 = {
  ex20: { titre: 'Exercice 20 · Gérer les lignes et les colonnes', ex: 'x20' },
  ex21: { titre: 'Exercice 21 · Gérer les lignes et les colonnes', ex: 'x21' },
  ex22: { titre: 'Exercice 22 · Mise en forme', ex: 'x22' },
  ex23: { titre: 'Exercice 23 · Mise en forme - Format de cellule', ex: 'x23' },
  ex24: { titre: 'Exercice 24 · Mise en forme - Pinceau magique', ex: 'x24' },
  ex25: { titre: 'Exercice 25 · Mise en forme - Style de cellule', ex: 'x25' },
  ex26: { titre: 'Exercice 26 · Thème et impression', ex: 'x26' },
}
...
// ======================================================================
const EX4 = {
  ex27: { titre: 'Exercice 27 · La somme automatique & l\'assistant fonction', ex: 'x27' },
  ex28: { titre: 'Exercice 28 · Les formules simples', ex: 'x28' },
  ex29: { titre: 'Exercice 29 · Les références absolues', ex: 'x29' },
  ex30: { titre: 'Exercice 30 · Les noms de cellules', ex: 'x30' },
  ex31: { titre: 'Exercice 31 · L\'Assistant Fonction & la fonction VPM', ex: 'x31' },
}
...
// ======================================================================
const EX5 = {
  ex32: { titre: 'Exercice 32 · Outils Rechercher & Remplacer', ex: 'x32' },
  ex33: { titre: 'Exercice 33 · Outils Convertir', ex: 'x33' },
  ex34: { titre: 'Exercice 34 · La formule ARRONDI', ex: 'x34' },
  ex35: { titre: 'Exercice 35 · La formule ARRONDI.INF', ex: 'x35' },
  ex36: { titre: 'Exercice 36 · La formule ARRONDI.SUP', ex: 'x36' },
  ex37: { titre: 'Exercice 37 · La formule TRONQUE', ex: 'x37' },
  ex39: { titre: 'Exercice 38 · Quelques fonctions dates', ex: 'x38' },
  ex45: { titre: 'Exercice 44 · La fonction VPM', ex: 'x39' },
  ex46: { titre: 'Exercice 45 · La fonction VA', ex: 'x40' },
  ex47: { titre: 'Exercice 46 · La fonction NPM', ex: 'x41' },
  ex40: { titre: 'Exercice 39 · La fonction DATEDIF', ex: 'x42' },
  ex41: { titre: 'Exercice 40 · Quelques fonctions dates 2', ex: 'x43' },
  ex42: { titre: 'Exercice 41 · Quelques fonctions Texte', ex: 'x44' },
  ex43: { titre: 'Exercice 42 · Formule GAUCHE, DROITE, CONCATENER', ex: 'x45' },
  ex44: { titre: 'Exercice 43 · Cas pratique formule texte', ex: 'x46' },
}
...
const ARRONDIS = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'On la construit de la même façon. **À toi de taper la formule.**',
      visuel: {
        type: 'construitformule', prefixe: '=', resultat: 'B2', resultatValeur: '77',
        grilles: { Feuille: { cols: ['A', 'B'], rows: [1, 2], cells: { A1: { t: 'Valeur', entete: true }, B1: { t: 'Résultat', entete: true }, A2: { t: '76,3', num: true }, B2: { t: '' } } } },
        sequence: [
          { type: 'suggestion', saisie: '=ARRONDI', consigne: 'Tu tapes « =ARRONDI ». Clique la fonction qui arrondit vers le HAUT.', items: [{ nom: 'ARRONDI' }, { nom: 'ARRONDI.INF' }, { nom: 'ARRONDI.SUP', desc: 'arrondit vers le haut' }, { nom: 'ARRONDI.AU.MULTIPLE' }], cible: 'ARRONDI.SUP', ajoute: 'ARRONDI.SUP(' },
          { type: 'clic', feuille: 'Feuille', cible: 'A2', ajoute: 'A2', consigne: 'Clique la cellule à arrondir.' },
          { type: 'saisir', ajoute: ';0', label: ';0', consigne: 'Tape ; puis 0 (zéro décimale).' },
          { type: 'saisir', ajoute: ')', label: ')', consigne: 'Ferme la parenthèse, puis Entrée.' },
        ],
        explication: 'ARRONDI.SUP va toujours vers le haut : 76,3 monte à 77.',
      },
    },
    {
      humeur: 'accueil',
    ...
    {
      humeur: 'pensif',
      dit: 'On la construit pas à pas, comme les arrondis. **À toi.**',
      visuel: {
        type: 'construitformule', prefixe: '=', resultat: 'B2', resultatValeur: '76',
        grilles: { Feuille: { cols: ['A', 'B'], rows: [1, 2], cells: { A1: { t: 'Valeur', entete: true }, B1: { t: 'Résultat', entete: true }, A2: { t: '76,3', num: true }, B2: { t: '' } } } },
        sequence: [
          { type: 'suggestion', saisie: '=TRON', consigne: 'Tu tapes « =TRON ». Clique la fonction qui COUPE les décimales, sans arrondir.', items: [{ nom: 'TRONQUE', desc: 'coupe les décimales, sans arrondir' }, { nom: 'TROUVE' }], cible: 'TRONQUE', ajoute: 'TRONQUE(' },
          { type: 'clic', feuille: 'Feuille', cible: 'A2', ajoute: 'A2', consigne: 'Clique la cellule.' },
          { type: 'saisir', ajoute: ';0', label: ';0', consigne: 'Tape ; puis 0 (garder zéro décimale).' },
          { type: 'saisir', ajoute: ')', label: ')', consigne: 'Ferme la parenthèse, puis Entrée.' },
        ],
        explication: 'TRONQUE coupe la décimale sans arrondir : 76,3 devient 76.',
      },
    },
    {
      humeur: 'pensif',
...
const FONCTIONSDATE = {
  ...
  narration: [
    ...
    { humeur: 'accueil', dit: `Exemple concret : l'ancienneté entre le 31/03/1990 et aujourd'hui. En B2, on met **=AUJOURDHUI()** (la date du jour, ${dateAujFR}), et on construit DATEDIF qui pointe sur A2 et B2.` },
    {
      ...
      visuel: {
        type: 'construitformule', prefixe: '=', resultat: 'C2', resultatValeur: `${ansDepuis(1990, 3, 31)} ans`,
        grilles: { Feuille: { cols: ['A', 'B', 'C'], rows: [1, 2], cells: { A1: { t: 'Naissance', entete: true }, B1: { t: 'Aujourd\'hui', entete: true }, C1: { t: 'Âge', entete: true }, A2: { t: '31/03/1990' }, B2: { t: dateAujFR }, C2: { t: '' } } } },
        sequence: [
          { type: 'saisir', ajoute: 'DATEDIF(', label: '=DATEDIF(', consigne: 'DATEDIF n\'a pas de suggestion : tape-la en entier, « =DATEDIF( ».' },
          { type: 'clic', feuille: 'Feuille', cible: 'A2', ajoute: 'A2;', consigne: 'Clique la date de début (la naissance).' },
          { type: 'clic', feuille: 'Feuille', cible: 'B2', ajoute: 'B2;', consigne: 'Clique la date de fin (aujourd\'hui).' },
          { type: 'saisir', ajoute: '"Y")', label: '"Y")', consigne: 'Tape l\'unité "Y" (années) et ferme la parenthèse.' },
        ],
        explication: `DATEDIF donne l'écart : ${ansDepuis(1990, 3, 31)} ans. Comme la fin = aujourd'hui, ça se recalcule tout seul chaque jour.`,
      },
    },
    {
      humeur: 'pensif',
    ...
    },
    {
      ...
      visuel: {
        type: 'construitformule', prefixe: '=', resultat: 'C2', resultatValeur: '22',
        grilles: { Feuille: { cols: ['A', 'B', 'C'], rows: [1, 2], cells: { A1: { t: 'Début', entete: true }, B1: { t: 'Fin', entete: true }, C1: { t: 'Jours ouvrés', entete: true }, A2: { t: '01/04/2025' }, B2: { t: '30/04/2025' }, C2: { t: '' } } } },
        sequence: [
          { type: 'suggestion', saisie: '=NB.JOURS', consigne: 'Tu tapes « =NB.JOURS ». Clique la fonction qui compte les jours OUVRÉS (INTL).', items: [{ nom: 'NB.JOURS' }, { nom: 'NB.JOURS.OUVRES' }, { nom: 'NB.JOURS.OUVRES.INTL', desc: 'jours ouvrés entre deux dates (week-ends et fériés exclus)' }], cible: 'NB.JOURS.OUVRES.INTL', ajoute: 'NB.JOURS.OUVRES.INTL(' },
          { type: 'clic', feuille: 'Feuille', cible: 'A2', ajoute: 'A2;', consigne: 'Clique la date de début.' },
          { type: 'clic', feuille: 'Feuille', cible: 'B2', ajoute: 'B2', consigne: 'Clique la date de fin.' },
          { type: 'saisir', ajoute: ')', label: ')', consigne: 'Ferme la parenthèse (les fériés sont facultatifs), puis Entrée.' },
        ],
        explication: 'Du 1er au 30 avril 2025 : 22 jours ouvrés (week-ends exclus).',
      },
    },
    {
      humeur: 'accueil',
    ...
    { humeur: 'accueil', dit: '**SERIE.JOURS.OUVRES** fait l\'inverse : à partir d\'une date, elle ajoute (ou retire) un nombre de jours ouvrés pour trouver une date d\'échéance ou de livraison.', visuel: { type: 'formule', formule: '=SERIE.JOURS.OUVRES(début ; nb_jours ; [fériés])' } },
    {
      ...
      visuel: {
        type: 'construitformule', prefixe: '=', resultat: 'C2', resultatValeur: '15/04/2025',
        grilles: { Feuille: { cols: ['A', 'B', 'C'], rows: [1, 2], cells: { A1: { t: 'Début', entete: true }, B1: { t: 'Jours ouvrés', entete: true }, C1: { t: 'Échéance', entete: true }, A2: { t: '01/04/2025' }, B2: { t: '10', num: true }, C2: { t: '' } } } },
        sequence: [
          { type: 'suggestion', saisie: '=SERIE', consigne: 'Tu tapes « =SERIE ». Clique la fonction qui donne une date après X jours ouvrés.', items: [{ nom: 'SERIE.JOUR' }, { nom: 'SERIE.JOURS.OUVRES', desc: 'date située un nombre de jours ouvrés après (ou avant) une date' }, { nom: 'SERIE.JOURS.OUVRES.INTL' }], cible: 'SERIE.JOURS.OUVRES', ajoute: 'SERIE.JOURS.OUVRES(' },
          { type: 'clic', feuille: 'Feuille', cible: 'A2', ajoute: 'A2;', consigne: 'Clique la date de début.' },
          { type: 'clic', feuille: 'Feuille', cible: 'B2', ajoute: 'B2', consigne: 'Clique le nombre de jours ouvrés à ajouter.' },
          { type: 'saisir', ajoute: ')', label: ')', consigne: 'Ferme la parenthèse, puis Entrée.' },
        ],
        explication: '10 jours ouvrés après le 01/04/2025 → échéance le 15/04/2025.',
      },
    },
    {
      humeur: 'pensif',
...
const FONCTIONSTEXTE = {
  ...
  narration: [
    ...
    { humeur: 'accueil', dit: '**GAUCHE** extrait les premiers caractères (par la gauche), **DROITE** les derniers (par la droite).', visuel: { type: 'formule', formule: '=GAUCHE(texte ; no_car)   =DROITE(texte ; no_car)' } },
    {
      ...
      visuel: {
        type: 'construitformule', prefixe: '=', resultat: 'B2', resultatValeur: 'FR',
        grilles: { Feuille: { cols: ['A', 'B'], rows: [1, 2], cells: { A1: { t: 'Code', entete: true }, B1: { t: 'Résultat', entete: true }, A2: { t: 'FR-2025-001' }, B2: { t: '' } } } },
        sequence: [
          { type: 'suggestion', saisie: '=GAU', consigne: 'Tu tapes « =GAU ». Clique la fonction qui prend les premiers caractères (à gauche).', items: [{ nom: 'GAUCHE', desc: 'extrait les premiers caractères, à gauche' }, { nom: 'GAUCHEB' }], cible: 'GAUCHE', ajoute: 'GAUCHE(' },
          { type: 'clic', feuille: 'Feuille', cible: 'A2', ajoute: 'A2', consigne: 'Clique la cellule de texte.' },
          { type: 'saisir', ajoute: ';2', label: ';2', consigne: 'Tape ; puis 2 (garder les 2 premiers caractères).' },
          { type: 'saisir', ajoute: ')', label: ')', consigne: 'Ferme la parenthèse, puis Entrée.' },
        ],
        explication: 'GAUCHE prend les 2 premiers caractères de « FR-2025-001 » : « FR ». (DROITE marche pareil, mais par la fin.)',
      },
    },
    {
      humeur: 'accueil',
    ...
    { humeur: 'accueil', dit: 'Notre but ici : dans le code **« FR-2025-001 »**, isoler **l\'année 2025**. Elle commence au **4e caractère** et fait **4 caractères** : c\'est exactement ce qu\'on va dire à STXT.', visuel: { type: 'tableur', cols: ['A'], rows: [1, 2], cells: { A1: { t: 'Code', entete: true }, A2: { t: 'FR-2025-001' } }, legende: 'F(1) R(2) -(3) 2(4) 0(5) 2(6) 5(7) : « 2025 » commence en position 4, sur 4 caractères.' } },
    {
      ...
      visuel: {
        ...
        grilles: { Feuille: { cols: ['A', 'B'], rows: [1, 2], cells: { A1: { t: 'Code', entete: true }, B1: { t: 'Résultat', entete: true }, A2: { t: 'FR-2025-001' }, B2: { t: '' } } } },
        sequence: [
          { type: 'suggestion', saisie: '=STXT', consigne: 'Tu tapes « =STXT ». Clique la fonction qui extrait un morceau au MILIEU.', items: [{ nom: 'STXT', desc: 'extrait des caractères au milieu, à partir d\'une position' }, { nom: 'STXTB' }], cible: 'STXT', ajoute: 'STXT(' },
          { type: 'clic', feuille: 'Feuille', cible: 'A2', ajoute: 'A2', consigne: 'Clique la cellule de texte.' },
          { type: 'saisir', ajoute: ';4', label: ';4', consigne: 'Tape ; puis 4 (on commence au 4e caractère).' },
          { type: 'saisir', ajoute: ';4', label: ';4', consigne: 'Tape ; puis 4 (nombre de caractères à prendre).' },
          { type: 'saisir', ajoute: ')', label: ')', consigne: 'Ferme la parenthèse, puis Entrée.' },
        ],
        explication: 'STXT part du 4e caractère et en prend 4 : « 2025 », pile au milieu.',
      },
    },
    {
      humeur: 'accueil',
...
const FONCTIONSFINANCIERES = {
  ...
  narration: [
    ...
    { humeur: 'accueil', dit: 'Le résultat (la durée) ira sur la ligne « Durée (mois) ». **Clique la cellule qui va le recevoir.**', visuel: { type: 'cliquecible', support: 'tableur', consigne: 'Clique la cellule de la Durée', cols: ['A', 'B'], rows: [1, 2, 3, 4], cells: { A1: { t: 'Capital', entete: true }, B1: { t: '10 000 €' }, A2: { t: 'Taux annuel', entete: true }, B2: { t: '2 %' }, A3: { t: 'Mensualité', entete: true }, B3: { t: '-102,45 €' }, A4: { t: 'Durée (mois)', entete: true } }, cible: 'B4', explication: 'Oui, B4 : à droite de « Durée (mois) ». C\'est là qu\'on écrit =NPM(…).' } },
    {
      ...
      dit: 'Étape par étape, dans la cellule B4 :',
      visuel: {
        type: 'construitformule', prefixe: '=', resultat: 'B4', resultatValeur: '107',
        grilles: { Feuille: { cols: ['A', 'B'], rows: [1, 2, 3, 4], cells: { A1: { t: 'Capital', entete: true }, B1: { t: '10 000 €' }, A2: { t: 'Taux annuel', entete: true }, B2: { t: '2 %' }, A3: { t: 'Mensualité', entete: true }, B3: { t: '-102,45 €' }, A4: { t: 'Durée (mois)', entete: true }, B4: { t: '' } } } },
        sequence: [
          { type: 'suggestion', saisie: '=NPM', consigne: 'Tu tapes « =NPM ». Clique la fonction qui calcule le nombre de paiements.', items: [{ nom: 'NPM', desc: 'nombre de paiements pour rembourser un emprunt' }, { nom: 'NB' }, { nom: 'NB.SI' }], cible: 'NPM', ajoute: 'NPM(' },
          { type: 'clic', feuille: 'Feuille', cible: 'B2', ajoute: 'B2', consigne: 'Clique le taux annuel (on le divisera par 12).' },
          { type: 'saisir', ajoute: '/12;', label: '/12;', consigne: 'Divise par 12 (taux par mois), puis mets un ;' },
          { type: 'clic', feuille: 'Feuille', cible: 'B3', ajoute: 'B3;', consigne: 'Clique la mensualité (en négatif, c\'est une sortie d\'argent).' },
          { type: 'clic', feuille: 'Feuille', cible: 'B1', ajoute: 'B1', consigne: 'Clique le capital emprunté.' },
          { type: 'saisir', ajoute: ')', label: ')', consigne: 'Ferme la parenthèse, puis Entrée.' },
        ],
        explication: 'Un prêt de 10 000 € à 2 %/an remboursé 102,45 €/mois : il faut 107 mois.',
      },
    },
    {
      humeur: 'pensif',
...
// ======================================================================
const EX6 = {
  ex48: { titre: 'Exercice 47 · Gérer les feuilles', ex: 'x47' },
  ex49: { titre: 'Exercice 49 · Protéger les feuilles', ex: 'x48' },
  ex50: { titre: 'Exercice 50 · Protéger et verrouiller les feuilles', ex: 'x49' },
  ex51: { titre: 'Exercice 48 · Les liaisons', ex: 'x50' },
}
...
const EX7 = {
  ...
  ex53: { titre: 'Exercice 52 · Les sauts de page', ex: 'x52' },
  ex54: { titre: 'Exercice 53 · Création de tableaux', ex: 'x53' },
  ex55: { titre: 'Exercice 54 · Le formulaire', ex: 'x54' },
  ex56: { titre: 'Exercice 55 · Tris et filtres', ex: 'x55' },
  ex57: { titre: 'Exercice 56 · Les sous-totaux', ex: 'x56' },
  ex58: { titre: 'Exercice 57 · La fonction SOUS.TOTAL', ex: 'x57' },
}
    ...
    },
    {
      ...
      visuel: {
        ...
        blocs: [
          ...
          { capture: { type: 'menu', items: [{ icone: '✂️', label: 'Couper' }, { icone: '📋', label: 'Copier' }, '-', { label: 'Liste déroulante de choix' }] } },
    ...
    { humeur: 'accueil', dit: 'Les sous-totaux regroupent tes lignes par critère (par ville, par vendeur…) et calculent automatiquement un total à chaque changement de groupe. Fini les calculs à la main.' },
    {
      ...
      visuel: {
        ...
        blocs: [
          ...
          { capture: { type: 'ruban', actif: 'Données', groupeNom: 'Plan', groupes: [{ icone: '⊞', label: 'Grouper' }, { icone: '⊟', label: 'Dissocier' }, { icone: 'Σ', label: 'Sous-total' }] } },
...
const EX8 = {
  ex59: { titre: 'Exercice 58 · Les graphiques simples', ex: 'x58' },
  ex60: { titre: 'Exercice 59 · Ajuster et déplacer les graphiques', ex: 'x59' },
  ex61: { titre: 'Exercice 60 · Modifier un graphique', ex: 'x60' },
  ex62: { titre: 'Exercice 61 · Modifier les axes et les séries', ex: 'x61' },
  ex63: { titre: 'Exercice 62 · Intervertir les lignes/colonnes', ex: 'x62' },
  ex64: { titre: 'Exercice 63 · Déplacer et imprimer un graphique', ex: 'x63' },
  ex65: { titre: 'Exercice 64 · Les graphiques mixtes ou combinés', ex: 'x64' },
  ex66: { titre: 'Exercice 65 · Les graphiques Sparklines', ex: 'x65' },
}
    ...
    },
    {
      ...
      visuel: {
        ...
        blocs: [
          ...
          { capture: { type: 'ruban', actif: 'Insertion', groupeNom: 'Graphiques', groupes: [{ icone: '📊', label: 'Histogramme' }, { icone: '📈', label: 'Courbe' }, { icone: '🥧', label: 'Secteurs' }, { icone: '⭐', label: 'Graphique\nrecommandé' }] } },
    ...
    },
    {
      ...
      visuel: {
        ...
        blocs: [
          ...
          { capture: { type: 'menu', items: [{ label: 'Zone de graphique' }, { label: 'Zone de traçage' }, { label: 'Série « Ventes »' }, { label: 'Axe vertical (Valeurs)' }, { label: 'Titre du graphique' }, { label: 'Légende' }] } },
    ...
    },
    {
      ...
      visuel: {
        ...
        blocs: [
          ...
          { capture: { type: 'menu', items: [{ label: 'Zone de graphique' }, { label: 'Zone de traçage' }, { label: 'Axe horizontal (Catégories)' }, { label: 'Axe vertical (Valeurs)' }, { label: 'Titre du graphique' }, { label: 'Légende' }] } },
...
const EX9 = {
  ex67: { titre: 'Exercice 66 · La consolidation par position', ex: 'x66' },
...
const CONSOPOSITION = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'La méthode, **à toi de la faire**. Sur la feuille **Synthèse** (tableau vide déjà prêt), ouvre **Données > Consolider**, choisis la fonction, ajoute chaque feuille source, coche la liaison, puis valide.',
      visuel: {
        type: 'consoliderinteractif',
        cases: ['lier'],
        sources: [{ nom: 'Janvier' }, { nom: 'Février' }, { nom: 'Mars' }],
        entetes: CONSO_ENTETES,
        lignes: CONSO_TOTAL,
        resultat: 'Synthèse consolidée ! Ebook Excel = 12 400 + 13 800 + 12 000 = 38 200 €. Comme tu as coché « Lier aux données source », elle se recalcule toute seule si un mois change.',
      },
    },
    {
      humeur: 'pensif',
      dit: 'Le bouton **Parcourir…** de la fenêtre sert à aller chercher une source dans un **autre classeur** : il ouvre l\'explorateur de fichiers pour le sélectionner.',
      visuel: { type: 'encart', label: 'À quoi sert « Parcourir… » ?', texte: 'Quand une de tes feuilles sources est dans un **autre fichier Excel**, clique **Parcourir…** pour aller la chercher, au lieu de sélectionner une plage du classeur ouvert.' },
    },
    {
      humeur: 'pensif',
      dit: 'Tu peux aussi consolider **sans préparer de tableau vide**. Sur une feuille vierge, refais **Données > Consolider**, mais cette fois sélectionne chaque plage **avec ses titres**, et coche **Ligne du haut** et **Colonne de gauche**.',
      visuel: {
        type: 'consoliderinteractif',
        titres: true,
        cases: ['ligneHaut', 'colGauche'],
        sources: [{ nom: 'Janvier' }, { nom: 'Février' }, { nom: 'Mars' }],
        entetes: CONSO_ENTETES,
        lignes: CONSO_TOTAL,
        resultat: 'Excel a créé le tableau consolidé tout seul, titres compris, sans aucune préparation. Les titres cochés (Ligne du haut, Colonne de gauche) lui ont servi de repères pour aligner les produits.',
      },
    },
    {
      humeur: 'pensif',
      dit: 'Un dernier détail pratique : avec la liaison, des petits boutons **+ / –** apparaissent à gauche du résultat. C\'est le **plan**. À toi de masquer le détail d\'un groupe.',
      visuel: { type: 'planconsointeractif', resultat: 'Le détail des 3 mois est masqué : il ne reste que le total « Ebook Excel = 38 200 € ». Reclique « + » pour le redévelopper. Les boutons 1 / 2 en haut à gauche font pareil pour tout le tableau d\'un coup (1 = totaux seuls, 2 = tout le détail).' },
    },
    {
      humeur: 'pensif',
...
const CONSOCATEGORIE = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'Regarde d\'abord les **feuilles sources** : les dispositions **diffèrent** (autre ordre, « Coaching » en plus, « Formations » absent). Par position ce serait impossible ; par catégorie, aucun souci.',
      visuel: {
        type: 'methode',
        blocs: [
          { capture: { type: 'tableaudonnees', brut: true, entetes: CONSO_ENTETES, lignes: CONSO_JAN, feuilles: CONSO_FEUILLES, feuilleActive: 'Janvier', legende: 'Feuille « Janvier » : 3 produits, dans un certain ordre.' } },
          { capture: { type: 'tableaudonnees', brut: true, entetes: CONSO_ENTETES, lignes: [['Coaching', '2 900 €'], ['Ebook Shaolin', '9 700 €'], ['Ebook Excel', '12 000 €']], feuilles: CONSO_FEUILLES, feuilleActive: 'Mars', legende: 'Feuille « Mars » : autre ordre, « Coaching » en plus, « Formations » absent.' } },
        ],
      },
    },
    {
      humeur: 'pensif',
      dit: 'À toi de consolider **par catégorie**. Même méthode que par position, avec **deux cases en plus** : sélectionne chaque plage **avec ses titres**, puis coche **Ligne du haut**, **Colonne de gauche** et **Lier aux données source**.',
      visuel: {
        type: 'consoliderinteractif',
        titres: true,
        cases: ['ligneHaut', 'colGauche', 'lier'],
        sources: [{ nom: 'Janvier' }, { nom: 'Février' }, { nom: 'Mars' }],
        entetes: CONSO_ENTETES,
        lignes: [['Ebook Excel', '38 200 €'], ['Ebook Shaolin', '28 500 €'], ['Formations', '14 200 €'], ['Coaching', '2 900 €']],
        resultat: 'Regroupé par libellé ! « Coaching » (présent seulement en Mars) apparaît quand même, et « Formations » (absent de Mars) est totalisé sur ses 2 mois. Ligne du haut + Colonne de gauche = Excel range par nom, pas par position.',
      },
    },
    {
      humeur: 'pensif',
...
const TCDTABLES = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'Étape indispensable : transformer chaque plage en **vrai Tableau nommé**. À toi : sur la feuille **Ventes**, mets la plage sous forme de tableau, puis nomme-le **T_ventes** (double-clic sur le nom).',
      visuel: {
        type: 'creertableauinteractif',
        colonnes: ['Zones Vente', 'Montant'],
        lignes: [['Ohio', '8 200 €'], ['Texas', '12 500 €'], ['Ohio', '6 400 €']],
        nom: 'T_ventes',
        resultat: 'La plage « Ventes » est un vrai Tableau nommé T_ventes (bandes de couleur, flèches de filtre, extension automatique). Fais pareil pour les 2 autres feuilles : Zones Vente devient T_zones, Vendeurs devient T_vendeurs. Tes 3 tables nommées sont prêtes à être reliées.',
      },
    },
    {
      humeur: 'pensif',
...
const TCDRELATIONS = {
  ...
  narration: [
    {
      humeur: 'pensif',
      dit: 'On crée le TCD en l\'ajoutant au **modèle de données** (c\'est lui qui permet de relier plusieurs tables). À toi de l\'insérer, étape par étape.',
      visuel: { type: 'inserertcdinteractif', resultat: 'TCD inséré et ajouté au modèle de données ! La zone du rapport est prête à gauche, la fenêtre des champs à droite. La case « Ajouter au modèle de données » est justement ce qui va rendre les relations possibles.' },
    },
    {
      humeur: 'pensif',
      dit: 'Le volet **Champs** liste tes 3 tables (T_ventes, T_zones, T_vendeurs). Maintenant, l\'étape clé : ouvrir la **gestion des relations** et créer le pont toi-même. Prends ton temps.',
      visuel: { type: 'relationinteractif', resultat: 'Relations créées ! Le pont T_ventes(Zones Vente) → T_zones(Zones Vente) que tu as construit, plus celui détecté automatiquement pour T_vendeurs. Grâce à la clé partagée « Zones Vente », Excel peut maintenant croiser les 3 tables.' },
    },
    {
      humeur: 'pensif',
      dit: 'Prends une seconde pour bien comprendre ce que tu viens de faire.',
      visuel: { type: 'encart', label: 'Comprendre la relation', texte: 'Une relation, c\'est un **pont** entre deux tables. **Table** = d\'où part le pont (T_ventes). **Colonne** = la colonne de départ qui contient le mot commun (Zones Vente). **Table associée** = où arrive le pont (T_zones). **Colonne associée** = la colonne d\'arrivée avec les **mêmes mots** (Ohio, Texas…). Ce mot commun, c\'est la **clé partagée** : grâce à lui, Excel sait que la vente « Ohio » et la zone « Ohio » parlent de la même chose.' },
    },
    {
      humeur: 'pensif',
      dit: 'Dernière étape, la plus satisfaisante : **construire la vue** en glissant les champs. À toi de jouer.',
      visuel: { type: 'tcdbuilder', feuilles: ['Ventes', 'TCD'], feuilleActive: 'TCD', champs: ['Vendeurs', 'Grade', 'Montant'], sequence: [{ champ: 'Vendeurs', zone: 'lignes', consigne: 'Glisse « Vendeurs » (de la table T_vendeurs) dans la zone Lignes.' }, { champ: 'Montant', zone: 'valeurs', consigne: 'Glisse « Montant » (de la table T_ventes) dans la zone Valeurs : Excel calcule la Somme de Montant.' }], etiquettes: ['Marie', 'Karim', 'Léa'], valeurLabel: 'Somme de Montant', valeurs: ['14 600 €', '12 500 €', '14 400 €'], total: '41 500 €', explication: 'Regarde la magie : « Vendeurs » vient de T_vendeurs, « Montant » vient de T_ventes. Ce rapport croise DEUX tables différentes, uniquement grâce aux relations (la clé partagée Zones Vente). Sans elles, impossible de totaliser par vendeur : on n\'aurait eu que le total par zone.' },
    },
    {
      humeur: 'pensif',
...
const EX10 = {
  ex71: { titre: 'Exercice 70 · La mise en forme conditionnelle', ex: 'x71' },
  ex72: { titre: 'Exercice 71 · La fonction SI simple', ex: 'x72' },
  ex73: { titre: 'Exercice 72 · La fonction SI imbriquée, ET, OU', ex: 'x73' },
  ex74: { titre: 'Exercice 73 · Les fonctions SI.ENS', ex: 'x74' },
  ex75: { titre: 'Exercice 74 · Les références semi-relatives', ex: 'x75' },
  ex76: { titre: 'Exercice 75 · La gestion des erreurs', ex: 'x76' },
}
...
const RAPPELREFNOMS = {
  ...
  narration: [
    ...
    {
      humeur: 'accueil',
      dit: 'À toi. Tu veux **figer** la cellule du taux de TVA (G10) pour qu\'elle ne bouge pas à la recopie. Sélectionne-la et appuie sur **F4**.',
      visuel: { type: 'refbuilder', base: 'G10', cible: '$G$10', avant: '=C2*', resultat: 'G10 est devenu $G$10 : la colonne ET la ligne sont figées. Recopie la formule où tu veux, elle pointera toujours vers le taux de TVA. Chaque nouvel appui sur F4 fait défiler les autres verrouillages ($ ligne, $ colonne).' },
    },
    {
      humeur: 'pensif',
...
const FONCTIONSI = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'Méthode 2 : la **saisie directe**. À toi de **construire le SI** toi-même, argument par argument. Un élève a la note 14 : on veut afficher « OK » s\'il a la moyenne, « À refaire » sinon.',
      visuel: {
        ...
        resultatValeur: 'OK',
        grilles: {
          Feuille: { cols: ['A', 'B'], rows: [1], cells: { A1: { t: '14', num: true }, B1: { t: '' } } },
        },
        sequence: [
          { type: 'clic', feuille: 'Feuille', cible: 'A1', ajoute: 'A1', consigne: 'Sur quelle valeur porte le test ? Clique la cellule de la note.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '> 10', val: '>10' }, { label: '< 10', val: '<10' }, { label: '= 10', val: '=10' }], cible: '>10', ajoute: '>10;', consigne: 'Quelle condition traduit « la note atteint la moyenne (10) » ?' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '"OK"', val: '"OK"' }, { label: '"À refaire"', val: '"À refaire"' }], cible: '"OK"', ajoute: '"OK";', consigne: 'Si la condition est VRAIE, qu\'affiche-t-on ? (le texte va entre guillemets)' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '"À refaire"', val: '"À refaire"' }, { label: '"OK"', val: '"OK"' }], cible: '"À refaire"', ajoute: '"À refaire")', consigne: 'Et si elle est FAUSSE ?' },
        ],
        explication: 'Ta formule teste A1>10 : si c\'est vrai elle affiche « OK », sinon « À refaire ». Ici 14 > 10, donc OK. C\'est la structure de tout SI : test ; si vrai ; si faux.',
      },
      plus: ['Dans la cellule, tape =SI(. Écris le test suivi d\'un point-virgule (A1>10;). Le résultat si vrai entre guillemets, puis ; ("OK";). Le résultat si faux, ferme la parenthèse et Entrée ("À refaire").'],
    },
    {
      humeur: 'accueil',
...
const SIIMBRIQUE = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'Elle a l\'air longue ? On la construit **palier par palier**, calmement. À toi de l\'assembler (la note est en B2 = 82). Le début =SI( est déjà tapé.',
      visuel: {
        type: 'construitformule',
        prefixe: '=SI(',
        resultat: 'C2',
        ...
        resultatValeur: 'Bien',
        grilles: {
          Feuille: { cols: ['B', 'C'], rows: [1, 2], cells: { B1: { t: 'Note', entete: true }, C1: { t: 'Commentaire', entete: true }, B2: { t: '82', num: true }, C2: { t: '' } } },
        },
        sequence: [
          { type: 'choix', feuille: 'Feuille', options: [{ label: 'B2>90;', val: 'B2>90;' }, { label: 'B2>=90;', val: 'B2>=90;' }], cible: 'B2>90;', ajoute: 'B2>90;', consigne: '1er palier : le test le plus haut. « Supérieur à 90 » (strictement), suivi d\'un point-virgule.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '"Excellent";', val: '"Excellent";' }, { label: 'Excellent;', val: 'Excellent;' }], cible: '"Excellent";', ajoute: '"Excellent";', consigne: 'Si ce test est VRAI, qu\'affiche-t-on ? (le texte va entre guillemets)' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: 'SI(  (on relance un SI = l\'imbrication)', val: 'SI(' }, { label: ')  (on ferme tout de suite)', val: ')' }], cible: 'SI(', ajoute: 'SI(', consigne: 'À la place du « sinon », on relance un SI( pour tester le palier suivant. C\'est ça, l\'imbrication.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: 'B2>75;"Bien";', val: 'B2>75;"Bien";' }, { label: 'B2>75;"Passable";', val: 'B2>75;"Passable";' }], cible: 'B2>75;"Bien";', ajoute: 'B2>75;"Bien";', consigne: '2e palier : test « supérieur à 75 », puis le résultat si vrai.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: 'SI(B2>50;"Passable";', val: 'SI(B2>50;"Passable";' }, { label: 'B2>50;"Passable";', val: 'B2>50;"Passable";' }], cible: 'SI(B2>50;"Passable";', ajoute: 'SI(B2>50;"Passable";', consigne: '3e palier : on relance encore un SI( (test > 50, résultat « Passable »).' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '"Insuffisant")))', val: '"Insuffisant")))' }, { label: '"Insuffisant")', val: '"Insuffisant")' }], cible: '"Insuffisant")))', ajoute: '"Insuffisant")))', consigne: 'Enfin, la valeur si TOUT est faux, puis ferme autant de parenthèses que de SI : )))' },
        ],
        explication: 'Excel lit de gauche à droite : 82 n\'est pas > 90, mais il est > 75 → « Bien ». Chaque SI( imbriqué teste le palier suivant, et on ferme autant de parenthèses que de SI ouverts. Étire la formule et chaque note reçoit son commentaire.',
      },
    },
    {
      humeur: 'pensif',
    ...
    {
      humeur: 'pensif',
      dit: 'Exemple avec **ET** : « Validé » si le CA dépasse 100 000 € **ET** la satisfaction dépasse 90 %. À toi de **construire la formule** (le début =SI(ET( est déjà tapé).',
      visuel: {
        type: 'construitformule',
        prefixe: '=SI(ET(',
        resultat: 'D2',
        resultatFeuille: 'Feuille',
        resultatValeur: 'Validé',
        grilles: {
          Feuille: { cols: ['A', 'B', 'C', 'D'], rows: [1, 2], cells: { A1: { t: 'Zone', entete: true }, B1: { t: 'CA', entete: true }, C1: { t: 'Satisf.', entete: true }, D1: { t: 'Bilan', entete: true }, A2: { t: 'Nord' }, B2: { t: '120 000', num: true }, C2: { t: '95 %', num: true }, D2: { t: '' } }, refsCouleur: { B2: 'bleu', C2: 'ambre' } },
        },
        sequence: [
          { type: 'clic', feuille: 'Feuille', cible: 'B2', ajoute: 'B2', consigne: 'La 1re condition porte sur le CA : clique la cellule B2.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '>100000;', val: '>100000;' }, { label: '<100000;', val: '<100000;' }], cible: '>100000;', ajoute: '>100000;', consigne: 'Le CA doit DÉPASSER 100 000 €. Choisis la bonne condition (le ; sépare du test suivant).' },
          { type: 'clic', feuille: 'Feuille', cible: 'C2', ajoute: 'C2', consigne: 'La 2e condition porte sur la satisfaction : clique la cellule C2.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '>90%)', val: '>90%)' }, { label: '>90)', val: '>90)' }], cible: '>90%)', ajoute: '>90%)', consigne: 'Elle doit dépasser 90 %. Garde le signe % (sinon Excel compare à 90 !), puis ferme la parenthèse du ET.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: ';"Validé"', val: ';"Validé"' }, { label: ';"À revoir"', val: ';"À revoir"' }], cible: ';"Validé"', ajoute: ';"Validé"', consigne: 'Si les DEUX conditions sont vraies, qu\'affiche-t-on ? (le texte va entre guillemets)' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: ';"À revoir")', val: ';"À revoir")' }, { label: ';"Validé")', val: ';"Validé")' }], cible: ';"À revoir")', ajoute: ';"À revoir")', consigne: 'Et si une seule manque ? Choisis le « sinon », puis ferme la parenthèse du SI.' },
        ],
        explication: '=SI(ET(B2>100000;C2>90%);"Validé";"À revoir") : le ET exige les DEUX conditions. Ici 120 000 > 100 000 ET 95 % > 90 %, donc « Validé ». Le ET, c\'est le videur strict.',
      },
    },
    {
      humeur: 'accueil',
    ...
    {
      humeur: 'pensif',
      dit: 'Même construction avec **OU** : cette fois, **une seule** condition vraie suffit. Construis-la pour la zone Sud (CA = 100 000 €, satisfaction = 90 %). Le début =SI(OU( est déjà là.',
      visuel: {
        type: 'construitformule',
        prefixe: '=SI(OU(',
        resultat: 'D2',
        resultatFeuille: 'Feuille',
        resultatValeur: 'À revoir',
        grilles: {
          Feuille: { cols: ['A', 'B', 'C', 'D'], rows: [1, 2], cells: { A1: { t: 'Zone', entete: true }, B1: { t: 'CA', entete: true }, C1: { t: 'Satisf.', entete: true }, D1: { t: 'Bilan', entete: true }, A2: { t: 'Sud' }, B2: { t: '100 000', num: true }, C2: { t: '90 %', num: true }, D2: { t: '' } }, refsCouleur: { B2: 'bleu', C2: 'ambre' } },
        },
        sequence: [
          { type: 'clic', feuille: 'Feuille', cible: 'B2', ajoute: 'B2', consigne: 'Clique la cellule du CA (B2) pour la 1re condition.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '>100000;', val: '>100000;' }, { label: '>=100000;', val: '>=100000;' }], cible: '>100000;', ajoute: '>100000;', consigne: 'Garde le test STRICTEMENT supérieur (>100000). On verra le piège juste après.' },
          { type: 'clic', feuille: 'Feuille', cible: 'C2', ajoute: 'C2', consigne: 'Clique la satisfaction (C2) pour la 2e condition.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '>90%)', val: '>90%)' }, { label: '>90)', val: '>90)' }], cible: '>90%)', ajoute: '>90%)', consigne: 'Elle doit dépasser 90 % (garde le %), puis ferme la parenthèse du OU.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: ';"Validé"', val: ';"Validé"' }, { label: ';"À revoir"', val: ';"À revoir"' }], cible: ';"Validé"', ajoute: ';"Validé"', consigne: 'Valeur si au moins UNE condition est vraie ?' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: ';"À revoir")', val: ';"À revoir")' }, { label: ';"Validé")', val: ';"Validé")' }], cible: ';"À revoir")', ajoute: ';"À revoir")', consigne: 'Valeur sinon, puis ferme la parenthèse du SI.' },
        ],
        explication: 'Surprise : « À revoir » ! 100 000 n\'est pas STRICTEMENT supérieur à 100 000, et 90 % pas > 90 % : les deux tests sont faux, donc OU renvoie FAUX. Pour inclure la valeur exacte, il aurait fallu >=. Le OU, c\'est le videur cool… mais ici personne n\'avait le bon ticket.',
      },
    },
    {
      humeur: 'pensif',
...
const NBSIENS = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'À toi de **construire la formule** : combien d\'**hommes célibataires gagnent plus de 50 000 €** ? On enchaîne trois paires colonne/critère. Suis les consignes.',
      visuel: {
        type: 'construitformule',
        prefixe: '=NB.SI.ENS(',
        resultat: 'F2',
        ...
        grilles: {
          Feuille: {
            ...
            rows: [1, 2, 3, 4, 5, 6],
            cells: {
              A1: { t: 'Nom', entete: true }, B1: { t: 'Genre', entete: true }, C1: { t: 'Situation', entete: true }, D1: { t: 'Revenu', entete: true }, F1: { t: 'Résultat', entete: true },
              A2: { t: 'Jean' }, B2: { t: 'Homme' }, C2: { t: 'Célibataire' }, D2: { t: '60 000', num: true }, F2: { t: '' },
              A3: { t: 'Marie' }, B3: { t: 'Femme' }, C3: { t: 'Mariée' }, D3: { t: '45 000', num: true },
              A4: { t: 'Antoine' }, B4: { t: 'Homme' }, C4: { t: 'Célibataire' }, D4: { t: '51 000', num: true },
              A5: { t: 'Paul' }, B5: { t: 'Homme' }, C5: { t: 'Marié' }, D5: { t: '70 000', num: true },
              A6: { t: 'Lucie' }, B6: { t: 'Femme' }, C6: { t: 'Célibataire' }, D6: { t: '55 000', num: true },
            },
          },
        },
        sequence: [
          { type: 'plage', feuille: 'Feuille', debut: 'B2', fin: 'B6', ajoute: 'B2:B6;', consigne: 'Quelle colonne teste le sexe ? Sélectionne-la en entier.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '"Homme"', val: '"Homme"' }, { label: '"Femme"', val: '"Femme"' }], cible: '"Homme"', ajoute: '"Homme";', consigne: 'On veut compter les… ? (1er critère, entre guillemets)' },
          { type: 'plage', feuille: 'Feuille', debut: 'C2', fin: 'C6', ajoute: 'C2:C6;', consigne: 'Quelle colonne teste la situation ? Sélectionne-la.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '"Célibataire"', val: '"Célibataire"' }, { label: '"Marié"', val: '"Marié"' }], cible: '"Célibataire"', ajoute: '"Célibataire";', consigne: 'On garde seulement les… ? (2e critère)' },
          { type: 'plage', feuille: 'Feuille', debut: 'D2', fin: 'D6', ajoute: 'D2:D6;', consigne: 'Quelle colonne teste le revenu ? Sélectionne-la.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '">50000"', val: '">50000"' }, { label: '"<50000"', val: '"<50000"' }, { label: '"=50000"', val: '"=50000"' }], cible: '">50000"', ajoute: '">50000")', consigne: 'Et le revenu doit être… ? (la comparaison va aussi entre guillemets)' },
        ],
        explication: 'Trois paires colonne/critère, toutes reliées par un ET implicite : Excel ne compte que les lignes qui sont Homme ET Célibataire ET > 50 000 €. Ici : Jean et Antoine.',
      },
      plus: ['Dans la cellule résultat, tape =NB.SI.ENS(. 1re paire : sélectionne la colonne Genre puis ;"Homme";. 2e paire : colonne Situation puis ;"Célibataire";. 3e paire : colonne Revenu puis ;">50000"). NB.SI (sans ENS) ne gère qu\'un seul critère ; NB.SI.ENS en gère 1 ou plusieurs.'],
    },
    {
      humeur: 'accueil',
...
const SOMMESIENS = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'À toi de **construire la formule** : le CA d\'**Alice** dans la région **Est**. Souviens-toi du piège : la colonne à totaliser vient en PREMIER. Suis les consignes.',
      visuel: {
        type: 'construitformule',
        prefixe: '=SOMME.SI.ENS(',
        resultat: 'D2',
        resultatFeuille: 'Feuille',
        grilles: {
          Feuille: {
            ...
            rows: [1, 2, 3, 4, 5, 6],
            cells: {
              A1: { t: 'Vendeur', entete: true }, B1: { t: 'Région', entete: true }, C1: { t: 'CA', entete: true }, D1: { t: 'Résultat', entete: true },
              A2: { t: 'Alice' }, B2: { t: 'Est' }, C2: { t: '150 000', num: true }, D2: { t: '' },
              A3: { t: 'Bob' }, B3: { t: 'Ouest' }, C3: { t: '90 000', num: true },
              A4: { t: 'Alice' }, B4: { t: 'Ouest' }, C4: { t: '80 000', num: true },
              A5: { t: 'Claire' }, B5: { t: 'Est' }, C5: { t: '120 000', num: true },
              A6: { t: 'Bob' }, B6: { t: 'Est' }, C6: { t: '60 000', num: true },
            },
          },
        },
        sequence: [
          { type: 'plage', feuille: 'Feuille', debut: 'C2', fin: 'C6', ajoute: 'C2:C6;', consigne: 'Quelle colonne veut-on TOTALISER ? Sélectionne-la (elle vient en premier, c\'est le piège !).' },
          { type: 'plage', feuille: 'Feuille', debut: 'A2', fin: 'A6', ajoute: 'A2:A6;', consigne: 'Maintenant, quelle colonne teste le vendeur ? Sélectionne-la.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '"Alice"', val: '"Alice"' }, { label: '"Bob"', val: '"Bob"' }, { label: '"Claire"', val: '"Claire"' }], cible: '"Alice"', ajoute: '"Alice";', consigne: 'On additionne le CA de quel vendeur ? (1er critère)' },
          { type: 'plage', feuille: 'Feuille', debut: 'B2', fin: 'B6', ajoute: 'B2:B6;', consigne: 'Quelle colonne teste la région ? Sélectionne-la.' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: '"Est"', val: '"Est"' }, { label: '"Ouest"', val: '"Ouest"' }], cible: '"Est"', ajoute: '"Est")', consigne: 'Et dans quelle région ? (2e critère)' },
        ],
        explication: 'La plage à totaliser (le CA) vient en PREMIER, puis les paires colonne/critère. Excel additionne le CA des seules lignes Alice ET Est : une seule ici, 150 000 €. Pense à figer les plages ($) avant de recopier.',
      },
      plus: ['Tape =SOMME.SI.ENS( puis sélectionne la colonne à totaliser (le CA) : C2:C6;. 1er critère : colonne Vendeur puis ;"Alice";. 2e critère : colonne Région puis ;"Est"). Pour recopier dans un tableau de synthèse, fige les plages avec des $ (F4 / ⌘+T).'],
    },
    {
      humeur: 'accueil',
...
const SIERREUR = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'Exemple : protéger une division contre le **#DIV/0!**. Ici B2 vaut 0 : sans protection, =A2/B2 planterait. À toi de **construire le SIERREUR** (le début =SIERREUR( est tapé).',
      visuel: {
        type: 'construitformule',
        prefixe: '=SIERREUR(',
        resultat: 'D2',
        ...
        resultatValeur: '-',
        grilles: {
          Feuille: { cols: ['A', 'B', 'D'], rows: [1, 2], cells: { A1: { t: 'V1', entete: true }, B1: { t: 'V2', entete: true }, D1: { t: 'Protégé', entete: true }, A2: { t: '30', num: true }, B2: { t: '0', num: true }, D2: { t: '' } }, refsCouleur: { A2: 'bleu', B2: 'ambre' } },
        },
        sequence: [
          { type: 'clic', feuille: 'Feuille', cible: 'A2', ajoute: 'A2', consigne: 'Clique la 1re valeur (A2), le numérateur de ta division.' },
          { type: 'saisir', ajoute: '/', label: '/', consigne: 'Tape l\'opérateur de division.' },
          { type: 'clic', feuille: 'Feuille', cible: 'B2', ajoute: 'B2', consigne: 'Clique le diviseur (B2). Il vaut 0 : la division va planter, on va l\'attraper !' },
          { type: 'choix', feuille: 'Feuille', options: [{ label: ';"-")', val: ';"-")' }, { label: ';"#ERREUR")', val: ';"#ERREUR")' }], cible: ';"-")', ajoute: ';"-")', consigne: 'Que veux-tu afficher À LA PLACE de l\'erreur ? Choisis un tiret propre, puis ferme la parenthèse.' },
        ],
        explication: '=SIERREUR(A2/B2;"-") : 30 ÷ 0 provoque une erreur, alors SIERREUR affiche « - » au lieu du vilain #DIV/0!. Quand la division marche, elle laisse passer le résultat normal. Ton tableau reste propre.',
      },
    },
    {
      humeur: 'accueil',
...
const EX11 = {
  ex77: { titre: 'Exercice 76 · La recherche V', ex: 'x77' },
  ex78: { titre: 'Exercice 77 · La recherche V', ex: 'x78' },
  ex79: { titre: 'Exercice 78 · La recherche V', ex: 'x79' },
  ex80: { titre: 'Exercice 79 · La recherche X', ex: 'x80' },
  ex81: { titre: 'Exercice 80 · La recherche X à 2 critères', ex: 'x81' },
  ex82: { titre: 'Exercice 81 · La recherche H', ex: 'x82' },
}
...
const RECHERCHEV = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'À toi de **construire la formule**, argument par argument. Suis chaque consigne : clique, sélectionne, choisis. La formule s\'écrit toute seule dans la barre au fil de tes gestes.',
      visuel: {
        type: 'construitformule',
        prefixe: '=RECHERCHEV(',
        resultat: 'D2',
        resultatFeuille: 'Commandes',
        grilles: {
          Commandes: { cols: ['A', 'B', 'C', 'D'], rows: [1, 2], cells: { A1: { t: 'Code article', entete: true }, B1: { t: 'Produit', entete: true }, C1: { t: 'Prix', entete: true }, D1: { t: 'Quantité', entete: true }, A2: { t: 'A1001' }, B2: { t: 'Clavier sans fil' }, C2: { t: '24,90 €', num: true }, D2: { t: '' } } },
          Stock: { cols: ['A', 'B'], rows: [1, 2, 3, 4, 5], cells: { A1: { t: 'Code article', entete: true }, B1: { t: 'Quantité', entete: true }, A2: { t: 'A1001' }, B2: { t: '5', num: true }, A3: { t: 'A1003' }, B3: { t: '12', num: true }, A4: { t: 'A1004' }, B4: { t: '8', num: true }, A5: { t: 'A1005' }, B5: { t: '20', num: true } } },
        },
        sequence: [
          { type: 'clic', feuille: 'Commandes', cible: 'A2', ajoute: 'A2;', consigne: 'Quelle valeur veut-on retrouver dans le stock ? Clique-la (elle est sur cette même ligne).' },
          { type: 'plage', feuille: 'Stock', debut: 'A2', fin: 'B5', ajoute: 'Stock!A2:B5;', consigne: 'Passe sur l\'onglet Stock et sélectionne la zone à fouiller : de la colonne clé jusqu\'à la valeur à ramener.' },
          { type: 'choix', feuille: 'Stock', options: ['1', '2', '3'], cible: '2', ajoute: '2;', consigne: 'Dans cette zone, en combien de colonnes se trouve la Quantité, en partant de la clé ?' },
...
const RECHERCHEX = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'À toi de **construire la RECHERCHEX**. Ici, gros changement : tu sélectionnes la colonne de recherche PUIS la colonne de retour, chacune de son côté. Suis les consignes.',
      visuel: {
        type: 'construitformule',
        prefixe: '=RECHERCHEX(',
        resultat: 'D2',
        ...
        sequence: [
          { type: 'clic', feuille: 'Commandes', cible: 'A2', ajoute: 'A2;', consigne: 'Quelle valeur cherche-t-on ? Clique-la (sur la même ligne que la formule).' },
          { type: 'plage', feuille: 'Stock', debut: 'A2', fin: 'A5', ajoute: 'Stock!A2:A5;', consigne: 'Sur Stock, sélectionne SEULEMENT la colonne où Excel doit chercher cette valeur.' },
          { type: 'plage', feuille: 'Stock', debut: 'B2', fin: 'B5', ajoute: 'Stock!B2:B5;', consigne: 'Maintenant, sélectionne SEULEMENT la colonne dont tu veux ramener la donnée (elle peut être n\'importe où).' },
...
const RECHERCHEXDEUX = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'À toi de **construire la formule** à deux critères. L\'astuce : on colle deux critères avec le signe **&** pour n\'en former qu\'un. Suis les consignes, le & s\'ajoute tout seul.',
      visuel: {
        type: 'construitformule',
        prefixe: '=RECHERCHEX(',
        resultat: 'I9',
        ...
        grilles: {
          Feuille: {
            ...
            cells: {
              A1: { t: 'Produit', entete: true }, B1: { t: 'Coloris', entete: true }, C1: { t: 'Taille', entete: true }, D1: { t: 'Prix', entete: true },
              A2: { t: 'Tshirt' }, B2: { t: 'Blanc' }, C2: { t: 'S' }, D2: { t: '15 €', num: true },
              A3: { t: 'Tshirt' }, B3: { t: 'Blanc' }, C3: { t: 'M' }, D3: { t: '17 €', num: true },
              A4: { t: 'Sweat' }, B4: { t: 'Gris' }, C4: { t: 'S' }, D4: { t: '25 €', num: true },
              A5: { t: 'Sweat' }, B5: { t: 'Gris' }, C5: { t: 'M' }, D5: { t: '27 €', num: true },
              A6: { t: 'Hoodie' }, B6: { t: 'Noir' }, C6: { t: 'S' }, D6: { t: '29 €', num: true },
              A7: { t: 'Hoodie' }, B7: { t: 'Noir' }, C7: { t: 'M' }, D7: { t: '32 €', num: true },
              G8: { t: 'Produit', entete: true }, H8: { t: 'Taille', entete: true }, I8: { t: 'Prix', entete: true },
              G9: { t: 'Hoodie' }, H9: { t: 'S' }, I9: { t: '' },
            },
          },
        },
        sequence: [
          { type: 'clic', feuille: 'Feuille', cible: 'G9', ajoute: 'G9&', consigne: 'Le client a choisi son produit (en haut à droite). Clique-le : c\'est le 1er critère.' },
          { type: 'clic', feuille: 'Feuille', cible: 'H9', ajoute: 'H9;', consigne: 'Colle son 2e critère : clique la taille voulue. Excel réunit les deux avec un &.' },
          { type: 'plage', feuille: 'Feuille', debut: 'A2', fin: 'A7', ajoute: 'A2:A7&', consigne: 'Dans le catalogue, sélectionne la colonne du 1er critère (les produits).' },
          { type: 'plage', feuille: 'Feuille', debut: 'C2', fin: 'C7', ajoute: 'C2:C7;', consigne: 'Colle la colonne du 2e critère (les tailles) : Excel fabrique les mêmes clés combinées.' },
...
const RECHERCHEH = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'À toi de **construire la RECHERCHEH**. Même logique que la RECHERCHEV, mais le référentiel est **couché** : la clé est sur une ligne, et on compte les LIGNES au lieu des colonnes. Suis les consignes.',
      visuel: {
        type: 'construitformule',
        prefixe: '=RECHERCHEH(',
        resultat: 'C2',
        resultatFeuille: 'Commandes',
        grilles: {
          Commandes: { cols: ['A', 'B', 'C'], rows: [1, 2], cells: { A1: { t: 'Produit', entete: true }, B1: { t: 'Code article', entete: true }, C1: { t: 'Quantité', entete: true }, A2: { t: 'Clavier sans fil' }, B2: { t: 'A1001' }, C2: { t: '' } } },
          Réf: { cols: ['A', 'B', 'C', 'D', 'E'], rows: [1, 2, 3], cells: { A1: { t: 'Code article', entete: true }, B1: { t: 'A1001' }, C1: { t: 'A1002' }, D1: { t: 'A1003' }, E1: { t: 'A1004' }, A2: { t: 'Prix', entete: true }, B2: { t: '24,90 €', num: true }, C2: { t: '39,90 €', num: true }, D2: { t: '149,00 €', num: true }, E2: { t: '89,00 €', num: true }, A3: { t: 'Quantité', entete: true }, B3: { t: '20', num: true }, C3: { t: '7', num: true }, D3: { t: '12', num: true }, E3: { t: '8', num: true } } },
        },
        sequence: [
          { type: 'clic', feuille: 'Commandes', cible: 'B2', ajoute: 'B2;', consigne: 'Quel code veut-on retrouver ? Clique-le (sur cette ligne).' },
          { type: 'plage', feuille: 'Réf', debut: 'B1', fin: 'E3', ajoute: 'Réf!B1:E3;', consigne: 'Sur la feuille Réf, sélectionne le bloc rectangulaire : de la ligne des codes jusqu\'à la ligne à ramener.' },
          { type: 'choix', feuille: 'Réf', options: ['1', '2', '3'], cible: '3', ajoute: '3;', consigne: 'En descendant depuis la ligne des codes, sur quelle ligne se trouve la Quantité ?' },
...
const EX12 = {
  ex83: { titre: 'Exercice 82 · La validation des données', ex: 'x83' },
  ex84: { titre: 'Exercice 83 · Les filtres avancés', ex: 'x84' },
  ex85: { titre: 'Exercice 84 · La suppression des doublons', ex: 'x85' },
  ex57: { titre: 'Exercice 56 · Les sous-totaux', ex: 'x56' },
  ex58: { titre: 'Exercice 57 · La fonction SOUS.TOTAL', ex: 'x57' },
}
...
const EX13 = {
  ex86: { titre: 'Exercice 85 · Ton premier TCD', ex: 'x86' },
  ex87: { titre: 'Exercice 86 · Créer un TCD', ex: 'x87' },
  ex88: { titre: 'Exercice 87 · Créer un nouveau TCD', ex: 'x88' },
  ex89: { titre: 'Exercice 88 · Les champs calculés dans un TCD', ex: 'x89' },
  ex90: { titre: 'Exercice 89 · Grouper les dates dans un TCD', ex: 'x90' },
  ex91: { titre: 'Exercice 90 · Grouper les valeurs numériques dans un TCD', ex: 'x91' },
  ex92: { titre: 'Exercice 91 · Changer la source de données d\'un TCD', ex: 'x92' },
}
...
const ANALYSERTCD = {
  ...
  narration: [
    ...
    {
      humeur: 'pensif',
      dit: 'Tu ajoutes une vente à **Nice** dans la feuille Ventes. **Vrai ou faux ?**',
      visuel: { type: 'vraifaux', affirmation: 'Le TCD affiche la vente de Nice tout seul, dès que je l\'ajoute dans la source.', bonne: false, explication: 'Faux : le TCD ne se met PAS à jour tout seul. Il garde en mémoire les données du moment où tu l\'as créé. Il faut l\'ACTUALISER pour qu\'il recharge la source.' },
    },
    {
      humeur: 'accueil',
      dit: 'À toi, la chaîne complète : **ajoute la vente de Nice dans la table source** (feuille Ventes), puis va sur la feuille TCD et **actualise-le**. Tu vas voir : sans actualiser, Nice n\'apparaît pas.',
      visuel: { type: 'tcdactualiser', classeur: 'VentesImmo.xlsx', source: [{ loc: 'Paris', mt: '250 000 €' }, { loc: 'Lyon', mt: '310 000 €' }, { loc: 'Marseille', mt: '180 000 €' }, { loc: 'Paris', mt: '170 000 €' }], nice: { loc: 'Nice', mt: '150 000 €' }, tcdAvant: { titre: 'Localisation', valeurTitre: 'Somme de Montant', lignes: [{ et: 'Paris', val: '420 000 €' }, { et: 'Lyon', val: '310 000 €' }, { et: 'Marseille', val: '180 000 €' }], total: '910 000 €' }, tcdApres: { titre: 'Localisation', valeurTitre: 'Somme de Montant', lignes: [{ et: 'Paris', val: '420 000 €' }, { et: 'Lyon', val: '310 000 €' }, { et: 'Marseille', val: '180 000 €' }, { et: 'Nice', val: '150 000 €', nouvelle: true }], total: '1 060 000 €' }, explication: 'Tu as ajouté Nice à la SOURCE, puis clic droit > Actualiser sur le TCD : la ligne Nice apparaît et le total passe à 1 060 000 €. Sans l\'actualisation, le TCD serait resté à 910 000 €. Raccourci : Alt + F5.' },
      plus: ['Pour que ton TCD reste synchrone avec les modifications du tableau source : clique droit n\'importe où dans le TCD > Actualiser. Ou, dans l\'onglet Analyse du tableau croisé dynamique, clique sur Actualiser. Astuce : dans les Options du TCD > onglet Données, tu peux cocher « Actualiser les données lors de l\'ouverture du fichier » pour automatiser.'],
    },
    {
      humeur: 'pensif',
      dit: 'Maintenant, tes ventes sont datées **au jour près** : illisible. Le TCD sait **regrouper** les dates par mois, trimestre ou année. Fais un clic droit sur la **colonne des dates** (les étiquettes de lignes), puis choisis **Grouper**.',
      visuel: { type: 'tcdscene', classeur: 'VentesImmo.xlsx', feuilles: ['Ventes', 'TCD'], feuilleActive: 'TCD', consigne: 'Clic droit sur la colonne des dates → Grouper', declencheur: 'menu', clicDroitLabel: 'Clic droit sur la colonne Date', items: [{ label: 'Développer/Réduire' }, { label: 'Trier' }, '-', { label: 'Grouper…' }, { label: 'Dissocier…' }], cible: 3, avant: { titre: 'Date de vente', valeurTitre: 'Somme de Montant', lignes: [{ et: '12/01/2020', val: '120 000 €' }, { et: '08/09/2020', val: '90 000 €' }, { et: '03/03/2021', val: '140 000 €' }, { et: '21/07/2021', val: '160 000 €' }], total: '510 000 €' }, apres: { titre: 'Années', valeurTitre: 'Somme de Montant', lignes: [{ et: '2020', val: '210 000 €' }, { et: '2021', val: '300 000 €' }], total: '510 000 €' }, explication: 'Clic droit > Grouper, puis tu choisis Années (ou Mois, Trimestres) : Excel replie les dates en groupes lisibles. Ici, 4 dates deviennent 2 années. Pour revenir au détail : clic droit > Dissocier.' },
      plus: ['Regrouper des dates : clique sur une date dans le TCD, clic droit > Grouper…, puis dans la fenêtre choisis la base (Années, Mois ou Jours). Maintiens Ctrl pour cumuler (ex. Années + Trimestres = découpage hiérarchique). Excel crée automatiquement les regroupements. Le bouton Grouper n\'est actif que pour un champ en Lignes ou Colonnes, jamais en Valeurs.'],
    },
    {
      humeur: 'pensif',
    ...
    {
      humeur: 'accueil',
      dit: 'Par défaut, un champ déposé dans **Valeurs** est calculé en… ?',
      visuel: { type: 'question', options: ['Somme', 'Moyenne', 'Nombre', 'Pourcentage'], bonne: 0, explication: 'Par défaut, Excel fait la SOMME. Pour changer : clic droit sur une valeur > Synthétiser les valeurs par > Moyenne, Nombre, Max, Min… selon ton besoin.' },
    },
    {
      humeur: 'pensif',
    ...
    { humeur: 'fier', dit: 'Actualiser, regrouper, afficher en %, filtrer par segments : ton TCD t\'obéit au doigt et à l\'œil. Un vrai tableau de bord vivant ! 🎉' },
  ],
}
