...
const ANALYSERTCD = {
  ...
  narration: [
    ...
    {
      humeur: 'accueil',
      dit: 'Donc : la vente de Nice a été ajoutée, mais le TCD ne la voit pas encore. **À toi de l\'actualiser** : fais un clic droit sur le TCD et trouve la bonne commande.',
      visuel: { type: 'tcdscene', classeur: 'VentesImmo.xlsx', feuilles: ['Ventes', 'TCD'], feuilleActive: 'TCD', consigne: 'Clic droit sur le TCD, puis clique la commande qui recharge les données', declencheur: 'menu', clicDroitLabel: 'Clic droit sur le TCD', items: [{ label: 'Copier' }, { label: 'Actualiser' }, { label: 'Trier' }, '-', { label: 'Paramètres de champ…' }], cible: 1, avant: { titre: 'Localisation', valeurTitre: 'Somme de Montant', lignes: [{ et: 'Paris', val: '420 000 €' }, { et: 'Lyon', val: '310 000 €' }, { et: 'Marseille', val: '180 000 €' }], total: '910 000 €' }, apres: { titre: 'Localisation', valeurTitre: 'Somme de Montant', lignes: [{ et: 'Paris', val: '420 000 €' }, { et: 'Lyon', val: '310 000 €' }, { et: 'Marseille', val: '180 000 €' }, { et: 'Nice', val: '150 000 €', nouvelle: true }], total: '1 060 000 €' }, explication: 'Clic droit > Actualiser recharge depuis la source : la ligne Nice apparaît et le total passe à 1 060 000 €. Raccourci : Alt + F5 (ou onglet Analyse du TCD > Actualiser).' },
    ...
    {
      humeur: 'pensif',
      dit: 'Tu veux le **poids de chaque zone** en pourcentage, sans écrire une seule formule ? Le TCD le fait. Fais un clic droit sur une valeur et cherche l\'option d\'affichage.',
      visuel: { type: 'tcdscene', classeur: 'VentesImmo.xlsx', feuilles: ['Ventes', 'TCD'], feuilleActive: 'TCD', consigne: 'Clic droit sur une valeur, puis trouve l\'option pour l\'afficher autrement (en %)', declencheur: 'menu', clicDroitLabel: 'Clic droit sur une valeur', items: [{ label: 'Synthétiser les valeurs par' }, { label: 'Afficher les valeurs' }, '-', { label: 'Paramètres des champs de valeurs…' }], cible: 1, avant: { titre: 'Localisation', valeurTitre: 'Somme de Montant', lignes: [{ et: 'Paris', val: '420 000 €' }, { et: 'Lyon', val: '310 000 €' }, { et: 'Marseille', val: '180 000 €' }], total: '910 000 €' }, apres: { titre: 'Localisation', valeurTitre: '% du total', lignes: [{ et: 'Paris', val: '46 %' }, { et: 'Lyon', val: '34 %' }, { et: 'Marseille', val: '20 %' }], total: '100 %' }, explication: 'Clic droit > Afficher les valeurs > « % du total général » : chaque montant devient un pourcentage. Paris pèse 46 % des ventes. Idéal pour comparer des proportions plutôt que des euros bruts.' },
